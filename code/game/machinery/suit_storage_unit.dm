...
/obj/machinery/suit_storage_unit/attack_hand(mob/user as mob)
	...
	if(panelopen) //The maintenance panel is open. Time for some shady stuff
		...
		dat+= "<font color ='black'>A small dial with a small lambda symbol on it. It's pointing towards a gauge that reads [issuperUV ? "15nm" : "185nm"]</font>.<BR> [SPAN("info", "<A href='byond://?src=\ref[src];toggleUV=1'> Turn towards [issuperUV ? "185nm" : "15nm"]</A>")]<BR>"
